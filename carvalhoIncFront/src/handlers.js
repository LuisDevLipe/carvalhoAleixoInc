import { show_popover, make_product, make_search_helper, make_pre_tag } from "./components.js";
...
function searchHandler(e) {
    ...
    callScraper(term).then((data) => {
        ...
        if (rawdata_checkbox.checked) {
            ...
            document.querySelector("main#scrape-results").prepend(make_pre_tag(data.data.data, term));
